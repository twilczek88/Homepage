            ...
            return <aside>
                <nav>
                    ...
                    <ul>
                        ...
                        <li><NavLink activeClassName={ active } to={ commonPath + '/projects' }>{ icons.projects }</NavLink></li>
                        <li><NavLink activeClassName={ active } to={ commonPath + '/contact' }>{ icons.contact }</NavLink></li>
                    </ul>
                </nav>
